...
public class POSApp {
    ...
    public static void addReservation() {
        ...
        for (Map.Entry<Integer, Table> tableEntry : Restaurant.getTableList().entrySet()) {
            ...
            Customer thisCustomer = new Customer(name, contactNumber);
            if (MembershipList.getMembersList().contains(thisCustomer)) {
                thisCustomer = MembershipList.getMembersList().get(MembershipList.getMembersList().indexOf(thisCustomer));
            }
